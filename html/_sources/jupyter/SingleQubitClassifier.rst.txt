...
optimizers tutorial for more information.

Note that random initialization

One possibility to play with is to use Phoenics for initial exploration
and a gradient based optimizer with the best phoenics results as
starting point.
