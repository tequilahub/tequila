...
class ExponentialPauliGate(RotationGateImpl):
    ...
    def __init__(self, paulistring, angle: float, control: List[int] = None, frozen: bool = False):
...
class DecompositionFirstOrderTrotter:
    ...
    def __call__(self, generators: List[QubitHamiltonian], *args, **kwargs) -> QCircuit:
        result = QCircuit()
        for g in generators:
